...
if __name__ == '__main__':
    ...
    tf_datasetPath='/home/yusufs/deepmind-research/meshgraphnets/data/cylinder_flow/'
    os.makedirs('/home/yusufs/meshGraphNets_pytorch/dataset/data_cylinder/', exist_ok=True)

    for split in ['train', 'test', 'valid']:
        ds = load_dataset(tf_datasetPath, split)
        save_path='/home/yusufs/meshGraphNets_pytorch/dataset/data_cylinder/'+ split  +'.h5'
