...
# def build_cnn_encoder(in_size, hidden_size, out_size, lay_norm=True):

#     # inputs =   nn.Input(shape=(in_size,1))
#     # y = nn.Linear(in_size, hidden_size)(inputs)
#     # y = nn.SiLU()(y)
#     # y = nn.Linear(hidden_size, hidden_size)(y)
#     # y = nn.SiLU()(y)
#     # y = nn.Linear(hidden_size, hidden_size)(y)
#     # y = nn.SiLU()(y)
#     # outputs = nn.Linear(hidden_size, out_size)(y)
#     # module = Model(inputs=inputs, outputs=outputs)
...
#         nn.SiLU(), 
#         nn.Unflatten(0, (hidden_size,hidden_size)), 
...
# def build_cnn_decoder(in_size, hidden_size, out_size, lay_norm=True):
