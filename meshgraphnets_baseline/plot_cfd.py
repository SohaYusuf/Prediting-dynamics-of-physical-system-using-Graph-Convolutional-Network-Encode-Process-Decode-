...
def main(unused_argv):
  ...
  anim = animation.FuncAnimation(fig, animate, frames=num_frames, interval=0.01)
  #plt.show(anim)
  anim.save("E:cfd1.png", writer='imagemagick')
    
  ani = animation.FuncAnimation(fig, animate, frames=num_frames)
  #plt.show()

  my_writer=animation.PillowWriter(fps=60, codec='libx264', bitrate=2)

  ani.save(filename='E:\data\cylinder_base.gif', writer=my_writer)
